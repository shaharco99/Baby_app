...
- **Found on phones, fixed in v1.16.1–1.16.2:** summary table headers broke mid-word ("Diaper/s", "חיתולי/ם", pre-existing "האכלו/ת"); v1.16.1 fixed headers (confirmed both phones) but squeezed the day to "Wednesda/y" in English; v1.16.2 weights sized from measured widths.
